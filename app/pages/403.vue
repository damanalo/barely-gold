  ...
  <div class="min-h-screen relative overflow-hidden">
    ...
    <div class="relative z-10 min-h-screen flex items-center justify-center p-4">
      <div class="w-full max-w-2xl text-center">
        ...
        <!-- Error title -->
        <div class="mb-6">
          <h2 class="text-3xl md:text-4xl font-bold text-white mb-3 tracking-wide">Access Forbidden</h2>
        ...
        <p class="text-lg md:text-xl text-white/90 mb-4 max-w-lg mx-auto leading-relaxed">
          You don't have permission to access this exclusive area.
        </p>
        <p class="text-base text-white/75 mb-10 max-w-md mx-auto">
          This content requires special authorization. If you believe this is an error, please contact an administrator.
        </p>
        ...
        <div class="flex items-center justify-center mb-10">
          ...
          <div class="mx-4">
            <UIcon name="i-heroicons-lock-closed" class="w-6 h-6 text-[var(--color-gold-400)]" />
          </div>
        ...
        <div class="text-white/60 text-sm">
          <p class="mb-2">Need access to this area?</p>
          <NuxtLink 
            to="/login" 
...
// Set page meta
useHead({
  title: '403 - Access Forbidden | Barely Gold',
  meta: [
